        ...
        <LayoutGroup>
          <AnimatePresence>
            <motion.div
              ...
              layout
              className="z-50 absolute top-0 bottom-0 right-0 left-0 w-screen h-screen flex flex-col justify-center items-center bg-zinc-900 bg-opacity-60 m-0 p-0 overflow-hidden backdrop-blur-md"
            >
              <motion.div
                layout
                className="relative w-11/12 h-11/12 lg:w-1/2 lg:h-1/2 min-h-fit p-4 flex flex-col space-y-2 bg-zinc-950 rounded-md border border-opacity-30 border-amber-400"
              >
